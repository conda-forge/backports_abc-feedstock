About backports_abc-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/backports_abc-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3666&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/backports_abc-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `backports_abc` can be installed with `conda`:
...
```
mamba install backports_abc
```

It is possible to list all of the versions of `backports_abc` available on your platform with `conda`:
...
```
mamba search backports_abc --channel conda-forge
```
...
mamba repoquery search backports_abc --channel conda-forge

# List packages depending on `backports_abc`:
mamba repoquery whoneeds backports_abc --channel conda-forge

# List dependencies of `backports_abc`:
mamba repoquery depends backports_abc --channel conda-forge
```
